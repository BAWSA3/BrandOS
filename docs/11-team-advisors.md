...
> "Build a team that's been in the trenches—people who've felt the pain of brand inconsistency firsthand and have the skills to solve it."
...
BrandOS requires expertise across three domains:
...
- Strong network in marketing/brand community
...
- Ensure system reliability and scale
...
- Shipped consumer-facing products
...
├── Head of Design/Co-Founder
└── Head of Marketing (hire Month 3-4)
```
...
- Angel investor
- Value: Founder support, fundraising
...
```
Application → Screen → Work Sample → Team Interview → Reference → Offer
...
- 10-15% reserved for employee option pool
- Refresher grants for retention and promotion
- Equity as core part of compensation
...
1. **Competitive base** - At or above market for role/stage
2. **Equity upside** - Meaningful ownership for early joiners
3. **Transparent bands** - Clear salary ranges per level
4. **Location-adjusted** - Cost of living considerations
5. **Performance-tied** - Raises based on impact, not tenure
