...
1. Never use the same CTA type 3 days in a row
2. Threads always end with RT + Follow
3. Hot takes always end with Agree/Disagree
4. Community posts always use Drop Handle or Reply
5. Value offers (reply triggers) max 1x per week
6. Sunday P2 always ends with Follow CTA
...
5. Anti-generic creator advice
6. Behind-the-scenes of scaling 33K → 50K

No theme should appear more than 3x in a week.

## Hashtag Usage

- #buildinpublic — community posts, build logs
- #vibecoding — code-related posts, BrandOS updates
- #creatoreconomy — broad reach posts about the creator space
- Use 1-2 max per post. Zero is fine too.

## Daily Non-Negotiables (in addition to posting)

- 15 min: strategic replies on 3-5 large accounts (100K+)
- 10 min: engage with your reply section
- 5 min: engage with 5 peers in 20K-50K range
