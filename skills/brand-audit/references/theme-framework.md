...
4. Could you group this with 3+ other posts under one label?
5. If they only had 1 tweet to represent their brand, would this be it?
...
- 100% hot takes = controversial but no substance
...
- Capitalization patterns (all lowercase = casual, Title Case = polished)
- Emoji frequency (0-1 = serious, 3+ = playful)
- Do they ask questions? (engagement driver)
- Do they reference their product/project? (builder signal)
