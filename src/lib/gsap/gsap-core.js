  ...
  distribute = function distribute(v) {
    ...
    return function (i, target, a) {
      ...
      if (!distances) {
        ...
        originY =
          wrapAt === _bigNum ? 0 : ratios ? (l * ratioY) / wrapAt - 0.5 : (from / wrapAt) | 0;
        max = 0;
        min = _bigNum;
  ...
  _replaceRandom = function _replaceRandom(s) {
    return s.replace(_randomExp, function (match) {
      ...
      var arIndex = match.indexOf('[') + 1,
        values = match
          .substring(arIndex || 7, arIndex ? match.indexOf(']') : match.length - 1)
          .split(_commaDelimExp);
...
export var Animation = /*#__PURE__*/ (function () {
  ...
  _proto.totalTime = function totalTime(_totalTime, suppressEvents) {
    ...
    if (
      ...
      (!this._initted && this._dur && _totalTime) ||
...
var _addComplexStringPropTween = function _addComplexStringPropTween(
  ...
  _updatePropTweens = function _updatePropTweens(
    ...
    while (i--) {
      ...
      pt.s =
        (start || start === 0) && !startIsRelative ? start : pt.s + (start || 0) + ratio * pt.c;
      pt.c = value - pt.s;
...
export var Tween = /*#__PURE__*/ (function (_Animation2) {
  ...
  _proto3.render = function render(totalTime, suppressEvents, force) {
    var prevTime = this._time,
      ...
      tTime =
        totalTime > tDur - _tinyNum && !isNegative ? tDur : totalTime < _tinyNum ? 0 : totalTime,
      time,
      pt,
      iteration,
      cycleDuration,
    ...
    if (!dur) {
      ...
      (timeline &&
        timeline.render(
          totalTime < 0 ? totalTime : timeline._dur * timeline._ease(time / this._dur),
          suppressEvents,
          force
        )) ||
  ...
  _proto3.resetTo = function resetTo(property, value, start, startIsRelative, skipRecursion) {
    ...
    if (
      _updatePropTweens(this, property, value, start, startIsRelative, ratio, time, skipRecursion)
    ) {
