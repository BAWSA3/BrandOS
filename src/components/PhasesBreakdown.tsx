...
const phases: Phase[] = [
  {
    ...
    description:
      "Turn your intuition into rules AI can follow. Define what makes your brand yours—so it stays consistent whether you're creating or someone else is.",
    features: ['Brand Identity', 'Safe Zones', 'Design Intents', 'Voice & Tone'],
    details: [
      {
        title: 'Brand Identity',
        description:
          'Define your name, colors, and core visual elements that make your brand recognizable.',
      },
      {
        title: 'Tone Spectrum',
        description:
          'Set sliders for formality, energy, confidence, and style to capture your unique voice.',
      },
      {
        title: 'Safe Zones',
        description: 'Lock critical brand elements while allowing flexibility in others.',
      },
      {
        title: 'Voice Samples',
        description: 'Add examples of your brand writing to train the AI on your style.',
      },
    ],
    icon: (
      <svg
  ...
  },
  {
    ...
    description:
      "Run any content through your DNA. Get a score, see what's off, and know exactly what to fix—before it goes live.",
    features: ['Content Scoring', 'Brand Cohesion', 'Guardrails', 'Consistency'],
    details: [
      {
        title: 'Content Scoring',
        description: 'Get a 0-100 score showing how well your content aligns with your brand.',
      },
      {
        title: 'Real-time Analysis',
        description: 'See tone analysis as you type with instant feedback.',
      },
      {
        title: 'Guardrails',
        description: 'Review content from creators and agencies against your guidelines.',
      },
      {
        title: 'Suggestions',
        description: 'Receive AI-powered rewrites that match your brand voice.',
      },
    ],
    icon: (
      <svg
  ...
  },
  {
    ...
    description:
      'Generate content that sounds like you from the start. Your DNA shapes every output—so you create faster without losing your voice.',
    features: ['Multi-format', 'Platform Adapt', 'Visual Concepts', 'Templates'],
    details: [
      {
        title: 'Multi-format Output',
        description: 'Generate tweets, emails, headlines, taglines, and more.',
      },
      {
        title: 'Platform Adaptation',
        description: 'Automatically adjust content for different social platforms.',
      },
      { title: 'Visual Concepts', description: 'Get AI-powered design direction and mood boards.' },
      {
        title: 'Brand Kit',
        description: 'Manage logos, colors, typography, and templates in one place.',
      },
    ],
    icon: (
      <svg
  ...
  },
  {
    ...
    description:
      "You've built the system. Now let it work. Automate content, enforce your DNA across tools, and watch your brand scale—without you in the middle of every decision.",
    features: ['Dashboard', 'History', 'Export', 'Compare'],
    details: [
      {
        title: 'Analytics Dashboard',
        description: 'Track content checks, scores, and brand health over time.',
      },
      {
        title: 'History & Memory',
        description: 'Review past generations and learn what works for your brand.',
      },
      {
        title: 'Export Guidelines',
        description: 'Download your brand guidelines as JSON or shareable links.',
      },
      {
        title: 'Competitor Analysis',
        description: 'Compare your brand voice against competitors.',
      },
    ],
    icon: (
      <svg
      ...
      >
        ...
        <div className="flex flex-col items-center gap-2 mt-12 animate-bounce">
          ...
          <svg
            ...
            viewBox="0 0 24 24"
            fill="none"
            className="text-brand-black-swiss/30"
            stroke="currentColor"
            strokeWidth="1.5"
          >
            ...
            >
              ...
              <div className="flex items-start justify-between mb-6">
                <div>
                  ...
                  {/* Title */}
                  <h2
                    className={`font-sans font-bold text-brand-black-swiss mb-2 transition-all duration-500 ${
                  ...
                  {/* Subtitle */}
                  <p className="font-sans text-base text-brand-black-swiss/50">{phase.subtitle}</p>
                </div>
