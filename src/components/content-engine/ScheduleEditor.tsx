...
import { ContentEngineConfig, DAYS_OF_WEEK } from '@/lib/agents/content-engine.types';
      ...
      <div className="grid grid-cols-7 gap-2">
        {DAYS_OF_WEEK.map((day) => (
          <div key={day} className="text-center">
            ...
            <div className="font-mono text-[10px] text-[var(--accent)] font-medium">
              {config.schedule[day].post1.format}
            </div>
          </div>
        ))}
      </div>
