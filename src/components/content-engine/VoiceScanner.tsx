  ...
  return (
    <div className="glass-card border border-[var(--surface-tertiary)] rounded-[var(--radius-md)] p-5 mb-4">
      ...
      <p className="font-mono text-[10px] text-[var(--text-quaternary)] mb-4">
        Enter your X handle to scan your recent posts and detect your writing style, tone, and
        topics.
      </p>
      ...
      {error && (
        <div
          ...
          style={{ background: 'rgba(255, 59, 48, 0.06)', borderColor: 'rgba(255, 59, 48, 0.15)' }}
        >
      ...
      {scan && (
        <div className="space-y-3 mb-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="label-mono font-bold text-[var(--text-secondary)]">
              {scan.suggestedVibe}
            </span>
          </div>
          ...
          {scan.toneWords.length > 0 && (
            <div>
              <div
                className="label-mono text-[var(--text-quaternary)] mb-1.5"
                style={{ fontSize: 9 }}
              >
                Tone
              </div>
              <div className="flex gap-1.5 flex-wrap">
                {scan.toneWords.map((w) => (
                  <span
                    key={w}
                    className="px-2.5 py-1 text-[10px] font-mono rounded-[var(--radius-sm)] bg-[var(--accent)] text-white font-medium"
                  >
                    {w}
                  </span>
                ))}
            ...
            <div>
              ...
              <div className="flex gap-1.5 flex-wrap">
                {scan.sampleTopics.map((t) => (
                  <span
                    key={t}
                    className="px-2.5 py-1 text-[10px] font-mono rounded-[var(--radius-sm)] border border-[var(--surface-tertiary)] text-[var(--text-secondary)]"
                  >
                    {t}
                  </span>
                ))}
