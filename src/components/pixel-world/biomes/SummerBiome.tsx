  ...
  return (
    <div className="absolute inset-0" style={{ imageRendering: 'pixelated' }}>
      ...
      <div
        ...
        style={{
          background:
            'linear-gradient(180deg, #4A90D9 0%, #6BB3E8 35%, #8FD4F0 60%, #C8E8F0 85%, #E8F5E0 100%)',
        }}
      />
      ...
      <svg
        ...
        style={{ bottom: '32%', height: '12%', opacity: 0.35 }}
      >
        <polygon
          points="0,40 0,20 8,10 16,18 24,8 32,16 40,5 48,15 56,8 64,18 72,6 80,14 88,10 96,20 104,8 112,16 120,4 128,14 136,10 144,18 152,6 160,16 168,8 176,14 184,10 192,20 200,8 208,16 216,5 224,15 232,10 240,18 248,6 256,14 264,10 272,20 280,8 288,16 296,12 304,18 312,8 320,14 320,40"
          fill="#2D7A1A"
        />
      </svg>
      ...
      {isActive && (
        <motion.div
          ...
          style={{
            background:
              'linear-gradient(135deg, transparent 30%, rgba(255,224,102,0.15) 50%, transparent 70%)',
            pointerEvents: 'none',
          }}
        />
      )}
