      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-8 text-gray-300">
          <section>
            ...
            <p className="mb-4">
              By accessing or using BrandOS ("the Service"), you agree to be bound by these Terms of
              Service ("Terms"). If you do not agree to these Terms, do not use the Service.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you and BrandOS. Please
          ...
          <section>
            ...
            <p className="mb-4">
              BrandOS is an AI-powered brand analysis and content generation platform that helps
              creators and businesses understand and develop their brand identity. Our Service
              includes:
            </p>
          ...
          <section>
            ...
            <p className="mb-4">
              Our Service integrates with X (Twitter) to provide brand analysis features. By using
              these features, you acknowledge and agree that:
            </p>
            <ul className="list-disc pl-6 space-y-2">
              <li>
                <strong>Authorization:</strong> You authorize BrandOS to access your X account
                information through X's OAuth authentication
              </li>
              <li>
                <strong>Data Access:</strong> We access your public profile information, tweets, and
                engagement metrics as authorized by you
              </li>
              <li>
                <strong>Limited Use:</strong> We use X data solely to provide brand analysis,
                scoring, and content recommendations
              </li>
              <li>
                <strong>No Posting:</strong> BrandOS does not post, like, retweet, or take any
                actions on your behalf on X without your explicit consent
              </li>
              <li>
                <strong>Revocation:</strong> You may revoke BrandOS's access to your X account at
                any time through your X account settings
              </li>
              <li>
                <strong>X Terms:</strong> Your use of X integration features is also subject to X's
          ...
          <section>
            ...
            <p className="mb-4">
              ...
              Service, including your brand information, text, and uploaded materials. By submitting
              content, you grant BrandOS a non-exclusive, worldwide, royalty-free license to use,
              process, and analyze it to provide the Service.
            </p>
            <p className="mb-4">
              <strong>Our Content:</strong> The Service, including its design, features, software,
              and content, is owned by BrandOS and protected by intellectual property laws. You may
              not copy, modify, distribute, or create derivative works without our permission.
            </p>
            <p>
              <strong>Feedback:</strong> Any feedback, suggestions, or ideas you provide about the
          ...
          <section>
            ...
            <p className="mb-4">
              Content generated by our AI tools is provided for your use, subject to the following:
            </p>
            <ul className="list-disc pl-6 space-y-2">
              <li>
                You are solely responsible for reviewing and ensuring the appropriateness of any
                AI-generated content before use
              </li>
              <li>
                AI-generated content may not be accurate, complete, or suitable for your purposes
              </li>
              <li>
                You should not rely on AI-generated content for legal, medical, financial, or other
                professional advice
              </li>
              <li>
                You are responsible for ensuring AI-generated content does not infringe on
                third-party rights
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p className="mb-4">
              The Service integrates with various third-party services, including but not limited
              to:
            </p>
            <ul className="list-disc pl-6 space-y-2">
            ...
            <p className="mt-4">
              Your use of these integrations is subject to the respective third party's terms of
              service and privacy policies. BrandOS is not responsible for the practices or content
          ...
          <section>
            ...
            <p>
              ...
              SECURE, ERROR-FREE, OR MEET YOUR REQUIREMENTS. WE DISCLAIM ALL WARRANTIES, INCLUDING
          ...
          <section>
            ...
            <p>
              TO THE MAXIMUM EXTENT PERMITTED BY LAW, BRANDOS AND ITS OFFICERS, DIRECTORS,
              EMPLOYEES, AND AGENTS SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL,
              CONSEQUENTIAL, OR PUNITIVE DAMAGES, INCLUDING LOSS OF PROFITS, DATA, OR GOODWILL,
              ARISING FROM YOUR USE OF THE SERVICE, EVEN IF WE HAVE BEEN ADVISED OF THE POSSIBILITY
          ...
          <section>
            ...
            <p>
              You agree to indemnify and hold harmless BrandOS and its officers, directors,
          ...
          <section>
            ...
            <p>
              ...
              posting the updated Terms on the Service or by email. Your continued use of the
              Service after changes constitutes acceptance of the new Terms. If you do not agree to
          ...
          <section>
            ...
            <p className="mt-2">
              <strong>Email:</strong> legal@mybrandos.app
            </p>
            <p className="mt-2">
              <strong>Website:</strong> https://mybrandos.app
            </p>
          </section>
        </div>
