...
const mockData: WrappedRevealData = {
  ...
  personalitySummary:
    'You bring ideas to life with precision and purpose. Your community trusts you to deliver substance over hype. Known for blending technical depth with accessible explanations.',
...
const altMockData: WrappedRevealData = {
  ...
  personalitySummary:
    'A bold futurist who commands attention with audacious visions. Your unconventional style polarizes but captivates millions.',
  tone: {
    formality: 15,
    energy: 90,
    confidence: 95,
...
const lowScoreMockData: WrappedRevealData = {
  ...
  personalitySummary:
    "You're on the journey of discovering your unique voice. Your authenticity shines through as you experiment with different content styles.",
  tone: {
    formality: 50,
    energy: 45,
    confidence: 35,
...
export default function TestWrappedPage() {
  ...
  return (
    <>
      ...
      <WrappedReveal data={data} onAnalyzeAnother={handleAnalyzeAnother} onClaim={handleClaim} />
    </>
  );
}
