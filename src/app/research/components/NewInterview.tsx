...
export default function NewInterview({ draft, setDraft, onSave, onCancel }: Props) {
  ...
  return (
    <div>
      ...
      {step === 1 && (
        <div>
          <div style={{ ...mono, color: 'rgba(0,0,0,0.35)', marginBottom: 20 }}>
            {'/* STEP 1 \u2014 SETUP */'}
          </div>

          <div style={{ marginBottom: 20 }}>
            <label
              style={{ ...mono, color: 'rgba(0,0,0,0.35)', display: 'block', marginBottom: 8 }}
            >
              X Handle
            </label>
            <input
          ...
          <div>
            <label
              style={{ ...mono, color: 'rgba(0,0,0,0.35)', display: 'block', marginBottom: 10 }}
            >
              Tier
            </label>
      ...
      {step === 3 && profile && (
        <div>
          <div style={{ ...mono, color: 'rgba(0,0,0,0.35)', marginBottom: 16 }}>
          ...
          {(Object.keys(trackGroups) as TrackKey[]).map((tk) => (
            <TrackSection
              ...
              responses={responses}
              onChange={(id, val) => setResponses((r) => ({ ...r, [id]: val }))}
            />
          ))}
        </div>
      )}
