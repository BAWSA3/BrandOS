...
export default function ExtensionAuthPage() {
  const [status, setStatus] = useState<'loading' | 'authenticating' | 'success' | 'error'>(
    'loading'
  );
  ...
  return (
    ...
    >
      <div style={{ textAlign: 'center', maxWidth: 400, padding: 32 }}>
        ...
        {status === 'loading' && <p style={{ color: '#888' }}>Checking authentication...</p>}
        ...
        {status === 'success' && (
          <>
            ...
            <p style={{ color: '#888', fontSize: 14 }}>
              You can close this tab and return to X. Brand scores will now appear next to
              usernames.
            </p>
          </>
        )}
