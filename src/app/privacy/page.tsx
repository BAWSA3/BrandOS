      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-8 text-gray-300">
          <section>
            ...
            <p className="mb-4">
              BrandOS ("we," "our," or "us") is committed to protecting your privacy. This Privacy
              Policy explains how we collect, use, disclose, and safeguard your information when you
              use our website and services at mybrandos.app ("the Service").
            </p>
            <p>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>
                <strong>Account Information:</strong> Name, email address (optional), and profile
                information when you create an account
              </li>
              <li>
                <strong>Brand Information:</strong> Brand names, colors, keywords, tone preferences,
                voice samples, and other brand-related content you submit
              </li>
              <li>
                <strong>Content:</strong> Text, documents, and other materials you submit for
                analysis or generation
              </li>
              <li>
                <strong>Communications:</strong> Messages you send to us, including support requests
                and feedback
              </li>
              <li>
            ...
            <p className="mb-4">
              When you connect your X account or use our X analysis features, we may collect:
            </p>
            <ul className="list-disc pl-6 space-y-2">
              <li>
                <strong>Profile Information:</strong> Username, display name, profile picture, bio,
                follower/following counts
              </li>
              <li>
                <strong>Tweets:</strong> Your public tweets, including text content and metadata
              </li>
              <li>
                <strong>Engagement Metrics:</strong> Public metrics such as likes, retweets,
                replies, and impressions
              </li>
              <li>
                <strong>Account Identifiers:</strong> X user ID for authentication and data
                association
              </li>
            </ul>
            <p className="mt-4 p-4 bg-gray-900 rounded-lg">
              <strong>Important:</strong> We only access data that you explicitly authorize through
              X's OAuth authentication process. We do not access your direct messages, private
              information, or data you have not authorized.
            </p>
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>
                <strong>Usage Data:</strong> Pages visited, features used, actions taken, and time
              ...
              <li>
                <strong>Cookies:</strong> Session cookies and preferences (see Section 9)
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>
                <strong>Service Delivery:</strong> To provide brand analysis, scoring, and content
                generation features
              </li>
              <li>
                <strong>Brand DNA Creation:</strong> To generate and maintain your Brand DNA profile
              </li>
              <li>
                <strong>X Analysis:</strong> To analyze your X presence and provide brand scoring
                and recommendations
              </li>
              <li>
                <strong>AI Processing:</strong> To process your content through AI models for
          ...
          <section>
            ...
            <p className="mt-4">
              <strong>We do NOT use X data to:</strong>
            </p>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                <strong>Anthropic (Claude):</strong> AI content analysis and generation
              </li>
              <li>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                <strong>Protection:</strong> To protect our rights, property, or safety, or that of
                our users
              </li>
              <li>
              ...
              <li>
                <strong>With Consent:</strong> When you have given explicit consent to share
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                <strong>Brand Data:</strong> Retained while your account is active; deleted upon
                account deletion
              </li>
              <li>
                <strong>X Data:</strong> Cached temporarily for performance; refreshed periodically
                and deleted upon account deletion or access revocation
              </li>
              <li>
                <strong>Content History:</strong> Retained while your account is active for your
                reference
              </li>
              <li>
            ...
            <p className="mt-4">
              You can request deletion of your data at any time by contacting us or deleting your
              account.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                <strong>Export:</strong> Export your brand data in a portable format
              </li>
              <li>
                <strong>Opt-out:</strong> Unsubscribe from marketing communications
              </li>
              <li>
                <strong>Revoke X Access:</strong> Disconnect your X account at any time through your
                X settings at https://twitter.com/settings/connected_apps or through your BrandOS
                account settings
              </li>
            </ul>
          ...
          <section>
            ...
            <p>
              ...
              changes by posting the new policy on the Service and updating the "Last updated" date.
          ...
          <section>
            ...
            <p className="mt-2">
              <strong>Email:</strong> privacy@mybrandos.app
            </p>
            <p className="mt-2">
